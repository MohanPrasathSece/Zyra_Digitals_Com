...
const Portfolio = (): JSX.Element => {
  ...
  const testimonials = [
    ...
    {
      quote:
        "Zyra Digitals are the best. They completed website within the deadline and delivered a clean, professional, and user-friendly experience. I highly recommend them to anyone looking to create premium websites.",
      author: "James Wilson",
            ...
            >
              ...
              >
                <div className="flex flex-col lg:flex-row lg:min-h-[600px] bg-white">
                  ...
                  {/* Project Details Box - Outside Image but inside the sticky card */}
